...
export function BottomTabBar({
  ...
  return /*#__PURE__*/_jsxs(Animated.View, {
    ...
    }), scrollableProps ? /*#__PURE__*/_jsxs(View, {
      style: scrollViewStyles.content,
      children: [scrollableProps?.pagingIcons?.right && selectedPage <= 1 && pages?.[selectedPage + 1] && /*#__PURE__*/_jsx(View, {
        style: scrollViewStyles.rightIcon,
        children: scrollableProps?.pagingIcons?.right
      }) || null, scrollableProps?.pagingIcons?.left && selectedPage >= 1 && /*#__PURE__*/_jsx(View, {
        style: scrollViewStyles.leftIcon,
        children: scrollableProps?.pagingIcons?.left
        ...
        children: /*#__PURE__*/_jsx(TabRoutes, {
          state: state,
