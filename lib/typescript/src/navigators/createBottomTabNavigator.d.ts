...
declare function BottomTabNavigator({ id, initialRouteName, backBehavior, children, layout, screenListeners, screenOptions, screenLayout, UNSTABLE_router, scrollableProps, ...rest }: BottomTabNavigatorProps): import("react/jsx-runtime").JSX.Element;
