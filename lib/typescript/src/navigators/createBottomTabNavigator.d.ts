...
declare function BottomTabNavigator({ initialRouteName, backBehavior, children, screenListeners, screenOptions, sceneContainerStyle, scrollEnabled, pagingIcons, scrollViewProps, tabCountPerPage, ...restWithDeprecated }: Props): JSX.Element;
