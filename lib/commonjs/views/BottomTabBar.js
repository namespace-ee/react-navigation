...
function BottomTabBar(_ref3) {
  ...
  const pages = _react.default.useMemo(() => {
    if (scrollEnabled) {
  ...
  const [selectedPage, setSelectedPage] = _react.default.useState(0);
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNative.Animated.View, {
  ...
  }, tabBarBackgroundElement), scrollEnabled ? /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: styles.content
  }, selectedPage <= 1 && (pages === null || pages === void 0 ? void 0 : pages[selectedPage + 1]) && /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: styles.rightIcon
  }, pagingIcons === null || pagingIcons === void 0 ? void 0 : pagingIcons.right) || null, selectedPage >= 1 && /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: styles.leftIcon
  }, pagingIcons === null || pagingIcons === void 0 ? void 0 : pagingIcons.left) || null, /*#__PURE__*/_react.default.createElement(_reactNative.ScrollView, _extends({
    accessibilityRole: "tablist",
    horizontal: true
  }, pagingIcons ? {
    onMomentumScrollEnd: _ref5 => {
      let {
        nativeEvent
      } = _ref5;
      const index = Math.round(nativeEvent.contentOffset.x / layout.width);

      if (index !== selectedPage) {
        setSelectedPage(index);
      }
    }
  } : undefined, scrollViewProps || {}), /*#__PURE__*/_react.default.createElement(TabRoutes, {
    state: state,
    ...
    style: styles.content
  }, /*#__PURE__*/_react.default.createElement(TabRoutes, {
    state: state,
    descriptors: descriptors,
    focusedOptions: focusedOptions,
    layout: layout,
...
const TabRoutes = _ref6 => {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, routes.map((route, index) => {
    ...
    return /*#__PURE__*/_react.default.createElement(_native.NavigationContext.Provider, {
      ...
      icon: (_options$tabBarIcon = options.tabBarIcon) !== null && _options$tabBarIcon !== void 0 ? _options$tabBarIcon : _ref7 => {
        let {
          color,
          size
        } = _ref7;
